    ...
    if request.method == 'POST':
        ...
        if name in invalid_imput or email in invalid_imput or phone in invalid_imput or message in invalid_imput:
            ...
            if email_pattern.match(email) and phone_pattern.match(phone):
                ...
                send_mail('You got a mail!', message, '', ['messouaboya17@gmail.com'])
...
def send_test_email(request):
    subject = 'Test Email'
    message = 'This is a test email sent using Gmail OAuth 2.0.'
    email_from = 'messouaboya17@gmail.com'
    recipient_list = [cfg.EMAIL_HOST_USER]  # Replace with your recipient email
